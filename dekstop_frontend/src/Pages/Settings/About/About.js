      ...
      <div className={classes.aboutContainer}>
        <div className={classes.banner}>
          ...
          <p>
            ...
            all-in-one tool that fosters boundless creativity for DevOps
            engineers by helping them stay organized.
          </p>
        </div>
        ...
        <div className={classes.flexrow}>
          <div className={classes.flexcol}>
            ...
            <p className={classes.p_}>
              ...
              productive by seeing all your activities in one place. We’ve
              adopted a minimalist design aesthetic and userfriendly software
              that offers a wonderful experience for DevOps engineers.
            </p>
          </div>
        ...
        <div className={classes.bluerow}>
          <div className={classes.flexcol}>
            ...
            <Link className={classes.btn} to='/contact-us'>
              Contact us
            </Link>
          </div>
