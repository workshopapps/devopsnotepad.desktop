      ...
      <div className={s.csrWrapper}>
        ...
        <div className={s.csrMainSection3} id={s.csrMainSection3}>
          ...
          <div className={s.csrMainSectionsDivs}>
            ...
            <p className={s.csrMainSectionDetails}>
              We take all feedback we receive from our users seriously, and
              ensure that we fulfill the requirements while taking the necessary
              steps to realise our corporate responsibilities.
            </p>
          </div>
        </div>
        ...
        <div className={s.csrMainSection5}>
          <p>
            As a team, we recognize that we must integrate our business values
            and operation to meet the expectation of our user in relation to the
