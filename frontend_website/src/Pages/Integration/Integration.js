              ...
              <div
                className={`${
                  item.banner_flex_position
                    ? 'container inHM_box flexDirection'
                    : 'container inHM_box'
                }`}
                key={i}
              >
                <div
                  className={`${
                    item.banner_flex_position ? 'inHmL inHmL2' : 'inHmL'
                  }`}
                >
                  <h3>{item.heading}</h3>
                  <p>{item.content}</p>
      ...
      <div className='get_more'>
        <div className='inGet_more'>
          <div className='subtitle'>
            ...
            <p>
              Opspad is the hub of your productivity - integrating the tools you
            ...
            {getMore.map((item, i) => {
              return (
                <div className='box' key={i}>
                  ...
                  <a
                    className={`${
                      item.gmail ? 'learnMore learnMoreGmail' : 'learnMore'
                    }`}
                    href={item.slug}
                  >
                    Learn More
