...
const Blog = () => {
    return ( 
        ...
        <div className={blogStyle.blogHero}>
            <h2>Blog</h2>
            <h1>OPS PAD BLOG</h1>
            <p>Stories from the community to help you have a better experience with OpsPad.</p>
            ...
            <div className={blogStyle.blogPostCard}>
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>Learn more about what kind of data we use and how we use it.<span>Read More</span></p>
                    </div>
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>Team Sandpaper on the complexities of sorting servers and designing specialized UIs for OpsPad. <span>Read More</span></p>
                    </div>
                    <div className={blogStyle.profile}>
                        <img 
                        src={profile} 
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>OpsPad has become the No1 DevOps tool according the DevOps Community, Nigeria. <span>Read More</span></p>
                    </div>
                    <div className={blogStyle.profile}>
                        <img 
                        src={profile} 
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>An insight of the latest feature, fixes and finesse we've added to OpsPad.<span>Read More</span></p>
                    </div>
                    <div className={blogStyle.profile}>
                        <img 
                        src={profile} 
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>Set up your OpsPad like a pro in 5 steps.<span>Read More.</span></p>
                    </div>
                    <div className={blogStyle.profile}>
                        <img 
                        src={profile} 
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>The best DevOps tools to start using today <span>Read More</span></p>
                    </div>
                    <div className={blogStyle.profile}>
                        <img 
                        src={profile} 
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>If you're like me, managing servers can be alot. Well, till I discovered Opspad! <span>Read More.</span></p>
                    </div>
                    <div className={blogStyle.profile}>
                        <img 
                        src={profile} 
                ...
                <div className={blogStyle.card}>
                    ...
                    <div className={blogStyle.blogCaption}>
                        <p>Read these books to gain knowledge about how to build highly available applicantions without impacting the quality.</p>
                    </div>
                    <div className={blogStyle.profile}>
                        <img 
                        src={profile} 
        ...
        <div className={blogStyle.newsletter}>
            ...
            <p>We want to hear from you. Let us know how we can help.We want to hear from you. Let us know how we can help.We want to hear from you. Let us know</p>
