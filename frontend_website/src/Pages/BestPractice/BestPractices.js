        ...
        <div>
            <div className={firstSectionWrapper}>
                <nav className={subLinksWrapper}>
                    ...
                    <button className={openSublinkBtn} 
                        onClick={() =>{ 
                         if((!openSublinks)){
                            setOpenSubinks(true)
                         }else{
                ...
                <div className={bestPracticediv}>
                    ...
                    <p>Implementable habits every Devops engineer should develop at work</p>
                </div>
                ...
                <div className={newUpdatesSction}>
                    ...
                    <div className={newUpdatesSctionContents}>
                        ...
                        <p className={newUpdateParagraph}>Find out what's up with this new update. Opspad tools and features that would bring out the best in you.</p>
                        <h5>BY  <span>NICHOLAS OTIJI</span></h5>
                    </div>
                </div>
                ...
                <div className={porpularPostSection}>
                    ...
                    <div className={posts}>
                        <div className={post}>
                            ...
                            <h1>Passionate about UX? Pay attention to web performance metrics</h1>
                            <h4>Learn how Opspad's features makes it easier for you to take notes and track progress of your different servers </h4>
                        </div>
                        <div className={post}>
                            <img src={img3} alt="" />
                            <div className={postTimeLine}>
                        ...
                        <div className={post}>
                            ...
                            <h1>See everything in your tech stack with these logging best practices</h1>
                            <h4>Learn how Opspad's features makes it easier for you to take notes and track progress of your different servers  </h4>
                        </div>
                    </div>
                </div>
                ...
                <div className={managingWrapper}>
                    <div className={managing}>
                        ...
                        <p>with all your passwords in one location, server events notifications, and To-Do notes!</p>
                ...
                <div className={devopsEngineer}>
                    <h1>DevOps engineers at Slack report a 5X increase in productivity!</h1>
                    <p>Discover OpsPad's flexible features designed to help improve productivity</p>
                    <button>Use OpsPad for FREE</button>    
                </div>
            </div>
        </div>
