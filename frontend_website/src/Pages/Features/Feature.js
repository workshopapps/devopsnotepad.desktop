...
const notificationandsigninoptionFlex = FeatureCSS.notificationandsigninoptionFlex
                    ...
                    <div className={notificationandsigninoptionFlex}>
                        <div className={notifications}>
                            ...
                            <p className={notificationsParagraph}>
                                Receive notifications indicating the 
                                status of your server and server tools.
                            </p>
                        </div>
                        <div className={profile}>
                            ...
                            <p className={profileParagraph}>
                                OpsPad allows you log in with a single ID across all your devices.
                            </p>
                        </div>  
                    </div>
                    <p className={notificationProfileText}>Designed for flexibility and security...</p>
                </div> 
