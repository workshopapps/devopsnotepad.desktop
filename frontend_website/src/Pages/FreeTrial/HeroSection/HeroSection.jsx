    ...
    <div className={style.THero}>
      <div className={style.THeroText}>
        <h1 className={style.HeroH1}>
          ...
          <span className={style.HeroH1Blue}>for free</span>
        </h1>
        <p>
          Save time and work more efficiently using Opspad. Sign-Up for a free
          trial and get to setup your account to view any type of logs in less
          than a minute added with safely storing your server information
        </p>
        <div className={style.FormTextDiv}>
          ...
          <h4 className='HeroH4'>
            Sign up for free. No credit cards required.
          </h4>
          <p>
            By entering your email, you have agreed to receiving marketing
            emails from Opspad.
          </p>
        </div>
      </div>
