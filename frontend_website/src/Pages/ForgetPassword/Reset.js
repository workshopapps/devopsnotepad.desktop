...
const Reset = () => {
  ...
  return (
    <div className={forgetStyles.Reset}>
      ...
      <p>
        Enter your Opspad <span>username</span> or the{' '}
        <span>email address</span> you used to register. We’ll send you an email
        with your username and a link to reset your password.
      </p>

      <div className={forgetStyles.inputEmail}>
        <form className={forgetStyles.form} onSubmit={handleSubmit}>
          ...
          />
          <button className={forgetStyles.submitBtn} type='submit'>
            Submit
          </button>
          <button
            ...
            className={forgetStyles.submitBtn}
          >
            Cancel
          </button>
        </form>
      ...
      <p>
        If you still need help, contact <span>Opspad Support</span>
      </p>
    </div>
  );
};
