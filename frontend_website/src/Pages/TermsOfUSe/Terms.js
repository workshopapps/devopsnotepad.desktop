...
            </ul>
          ...
          <p>
            ...
            Basic Subscriber Informationwith anyone, that other person may be
            able to take control of the account, and we may not be able to
            determine who is the proper Account Holder. We will not have any
            liability to you (or anyone you share your Basic Subscriber
            Information with) as a result of your or their actions under those
            circumstances.
          </p>
          <h4>Are There Rules About What I Can Do on the OpsPad Service?</h4>
          <p>
            Yes. Your use of the OpsPad must be in these Terms. Regarding your
            use of the OpsPad Service; agree that you are responsible for your
            conduct and all conduct under your account. In as much as passwords
            to your different servers are secured and stored for you, you agree
            to safeguard your password and to keep your Basic Subscriber
            Information current. You also agree that you will not share your
            account credentials or give others access. In addition, you
            understand that all Content created, transmitted, stored, or
            displayed in your account, is your sole responsibility.
          </p>
          <h4>What Information Does OpsPad  Collect?</h4>
          <p>
            OpsPad allows you to input, upload, or store in the OpsPad Service
            any text and other data you choose to store concerning servers and
            logs. We also collect and receive the following types of
            information: Basic subscriber information. To open your account and
            process payments, we collect and receive identifiers like your email
            address, and since there’s no subscription policy, no billing
            information is required.  Usage data. We collect and log Internet or
            other electronic network information on how you and others access
            and use it, for example, the act of creating a note or sharing a
            note. Usage data may be collected through cookies and similar
            technologies. Location information. We collect the IP address you
            use to connect to the OpsPadService and — if you choose to share it
            — your location information from a mobile device.  Device
            information. We collect information about the number and type of
            devices you use to connect to the OpsPad Service, as well as
            information about the operating systems on those devices. For
            example, when you install, modify, or use an OpsPad application we
            may collect personal information in order for our services to
            function properly, such as your device’s unique hardware identifiers
            (IMEI, SIM number, or other identifier). When you install, modify,
            or use an OpsPad application, you may see permission requests or
            alerts regarding the device capabilities the application could
            potentially use.
          </p>
          <h4>How Does OpsPad Use My Information?</h4>
          <p>
            We have specific rules for how and when we use the information we
            collect and receive. We are committed to protecting the privacy of
            your information. We use the information we collect and receive to
            provide, maintain, and improve the Opspad Service; to provide
            troubleshooting and customer support; to protect the OpsPad Service
            for all our users and to contact you.  Maintaining our Services. To
            provide troubleshooting and customer support, our Customer Support
            team may need to access your information, such as your account email
            address and information about the OpsPad application you are using,
            subject to the protections described below.   Protecting against
            security threats, abuse, and illegal activity. As part of our
            efforts to protect your account and the functionality of the OpsPad 
            Service, our systems may analyze the logs and information you send
            to and from your OpPad account and the notes you share to detect
            other potential security concerns.
          </p>
          <h4>CHOICE OF LAW</h4>
          <p>
            The laws of the state or country where you live govern all claims
            and disputes under this agreement, including breach of contact
            claims and claims under state consumer protection laws, unfair
            competition laws, implied warranty laws, for unjust enrichment, and
            in tort. If you acquired the software in any other country, the laws
            of that country apply. This agreement describes certain legal
            rights. You may have other rights, including consumer rights, under
            the laws of your state or country. You may also have rights with
          ...
          <p>
            ...
            to load the OpsPad software (for example a PC, laptop, mobile or
            tablet) under your control. You are responsible for ensuring your
            device meets the minimum requirements of the OpsPad  software. You
            are not permitted to: Edit, alter, modify, adapt, translate or
            otherwise change the whole or any part of the Software nor permit
            ...
            for any commercial purpose.  Allow any third party to use the
            Software on behalf of or for the benefit of any third party Use the
            Software in any way which breaches any applicable local, national or
            international law Use the Software for any purpose that OpsPad 
            Website considers is a breach of this EULA agreement.  Intellectual
            Property and Ownership OpsPad Website shall at all times retain
            ...
            in the Software, including any modifications made to it) shall
            remain the property of OpsPad Website. OpsPad Website reserves the
            right to grant licenses to use the Software to third parties.
          </p>
          ...
          <p>
            ...
            any cause beyond our reasonable control. Suppose any provision or
            part of a provision of these Terms of Use is determined to be
            unlawful, void, or unenforceable. In that case, that provision or
            ...
            will not be construed against us by having drafted them. As a result
            of this, you waive any defenses you may have based on the electronic
