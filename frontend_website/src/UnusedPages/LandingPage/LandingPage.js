      ...
      <div>
        <div className={`${style.landPage_flex} ${style.landPage_section1}`}>
          <div className={style.landPage_col1}>
            ...
            <p className={`${style.landPage_p} ${style.tabp}`}>
              Monitor, document and modify aspects of servers you manage - on
              the go!
            </p>
        ...
        <div className={`${style.landPage_flex} ${style.landPage_section3}`}>
          <div className={style.landPage_sectionItems1}>
            ...
            <p>
              Organize your notes, passwords, and servers in one location to
              help you remember everything and tackle any job. Notifications,
              ofcourse, so you miss nothing!
            </p>
          </div>
        ...
        <div className={style.landPage_section5}>
          ...
          <div className={style.landPage_section5grid}>
            ...
            <div className={style.landPage_section5_div2}>
              <img src={frank} alt='' />
              <p>
                I’ve been able to move around more, knowing I can track my
                servers on the go!
                <br />-
              </p>
              <h4>Frank George</h4>
